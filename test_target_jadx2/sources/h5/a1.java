...
public class a1 extends AbstractC1943g {
    public a1(InterfaceC1945h interfaceC1945h) {
    ...
    public void b(View view, String str, Object obj) {
        str.hashCode();
        if (str.equals("mode")) {
            ((b1) this.f22417a).setMode(view, obj == null ? null : (String) obj);
        } else if (str.equals("debug")) {
            ((b1) this.f22417a).setDebug(view, obj == null ? false : ((Boolean) obj).booleanValue());
        } else {
