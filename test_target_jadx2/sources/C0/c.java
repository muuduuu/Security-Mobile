...
public abstract class c {
    ...
    private static final String[] f734a = new String[0];
    ...
    public static String[] a(EditorInfo editorInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return strArr != null ? strArr : f734a;
        }
        ...
        return stringArray != null ? stringArray : f734a;
    }
    ...
    private static void h(EditorInfo editorInfo, CharSequence charSequence, int i10, int i11) {
        ...
        g(editorInfo, i13 != i12 ? TextUtils.concat(charSequence.subSequence(i15, i15 + min2), charSequence.subSequence(i11, min + i11)) : charSequence.subSequence(i15, min2 + i13 + min + i15), min2, i13 + min2);
    }
}
