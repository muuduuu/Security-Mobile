...
class J0 extends CameraCaptureSession.CaptureCallback {

    /* renamed from: b, reason: collision with root package name */
    a f41756b = null;

    /* renamed from: a, reason: collision with root package name */
    final Map f41755a = new HashMap();
    ...
    private List b(CaptureRequest captureRequest) {
        List list = (List) this.f41755a.get(captureRequest);
        return list != null ? list : Collections.emptyList();
    }

    void a(CaptureRequest captureRequest, List list) {
        List list2 = (List) this.f41755a.get(captureRequest);
        if (list2 == null) {
            this.f41755a.put(captureRequest, list);
            return;
        }
        ArrayList arrayList = new ArrayList(list.size() + list2.size());
        arrayList.addAll(list);
        arrayList.addAll(list2);
        this.f41755a.put(captureRequest, arrayList);
    }
    ...
    public void onCaptureSequenceAborted(CameraCaptureSession cameraCaptureSession, int i10) {
        Iterator it = this.f41755a.values().iterator();
        while (it.hasNext()) {
