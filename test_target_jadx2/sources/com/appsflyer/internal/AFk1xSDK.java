...
public final class AFk1xSDK {
    ...
    public static final int getMediationNetwork(String str) {
        ...
        int i10 = 0;
        int intValue = ((matchGroup == null || (value3 = matchGroup.getValue()) == null || (intOrNull3 = StringsKt.toIntOrNull(value3)) == null) ? 0 : intOrNull3.intValue()) * HVFrameRecorder.BITRATE;
