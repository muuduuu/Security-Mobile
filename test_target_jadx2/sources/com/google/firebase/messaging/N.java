...
public class N {
    ...
    private final Bundle f28086a;

    public N(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f28086a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f28086a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f28086a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f28086a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f28086a);
        for (String str : this.f28086a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
