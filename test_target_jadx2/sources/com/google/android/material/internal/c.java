...
public abstract class c {
    ...
    private static final ThreadLocal f27247a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f27248b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f27247a;
        ...
        ThreadLocal threadLocal2 = f27248b;
