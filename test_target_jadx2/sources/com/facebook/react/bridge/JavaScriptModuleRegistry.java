...
public final class JavaScriptModuleRegistry {
    ...
    public synchronized <T extends JavaScriptModule> T getJavaScriptModule(CatalystInstance catalystInstance, Class<T> cls) {
        T t10 = (T) this.mModuleInstances.get(cls);
        if (t10 != null) {
            return t10;
        }
        T t11 = (T) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new JavaScriptModuleInvocationHandler(catalystInstance, cls));
