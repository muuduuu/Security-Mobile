...
public class SmallDisplaySizeQuirk implements K0 {

    /* renamed from: a, reason: collision with root package name */
    private static final Map f14336a;
    ...
    static boolean g() {
        return f14336a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size f() {
        return (Size) f14336a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
