...
class C1418u {
    ...
    private static final int[] f14261c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    private final ProgressBar f14262a;

    /* renamed from: b, reason: collision with root package name */
    private Bitmap f14263b;
    ...
    C1418u(ProgressBar progressBar) {
        this.f14262a = progressBar;
    }
    ...
    void c(AttributeSet attributeSet, int i10) {
        h0 v10 = h0.v(this.f14262a.getContext(), attributeSet, f14261c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f14262a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f14262a.setProgressDrawable(d(h11, false));
        }
        v10.x();
    }
