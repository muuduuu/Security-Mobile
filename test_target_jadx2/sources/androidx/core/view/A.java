...
public abstract class A {
    ...
    public static MenuItem a(MenuItem menuItem, AbstractC1485b abstractC1485b) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            return ((InterfaceMenuItemC4603b) menuItem).a(abstractC1485b);
        }
    ...
    public static void b(MenuItem menuItem, char c10, int i10) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setAlphabeticShortcut(c10, i10);
    ...
    public static void c(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setContentDescription(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void d(MenuItem menuItem, ColorStateList colorStateList) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setIconTintList(colorStateList);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void e(MenuItem menuItem, PorterDuff.Mode mode) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setIconTintMode(mode);
        } else if (Build.VERSION.SDK_INT >= 26) {
            a.j(menuItem, mode);
        }
    }
    ...
    public static void f(MenuItem menuItem, char c10, int i10) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setNumericShortcut(c10, i10);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void g(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof InterfaceMenuItemC4603b) {
            ((InterfaceMenuItemC4603b) menuItem).setTooltipText(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
