...
public abstract class b {
    ...
    private static final ThreadLocal f15694a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f15695b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f15694a;
        ...
        ThreadLocal threadLocal2 = f15695b;
