...
final class OpenSSLX509CRL extends X509CRL {
    ...
    static List<OpenSSLX509CRL> fromPkcs7DerInputStream(InputStream inputStream) {
        ...
        try {
            try {
                ...
                for (long j10 : d2i_PKCS7_bio) {
                    if (j10 != 0) {
                        arrayList.add(new OpenSSLX509CRL(j10));
                    }
                }
                return arrayList;
            } catch (Exception e10) {
    ...
    static List<OpenSSLX509CRL> fromPkcs7PemInputStream(InputStream inputStream) {
        OpenSSLBIOInputStream openSSLBIOInputStream = new OpenSSLBIOInputStream(inputStream, true);
        try {
            try {
                ...
                for (long j10 : PEM_read_bio_PKCS7) {
                    if (j10 != 0) {
                        arrayList.add(new OpenSSLX509CRL(j10));
                    }
                }
