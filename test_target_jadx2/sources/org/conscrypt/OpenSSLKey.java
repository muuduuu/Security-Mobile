...
final class OpenSSLKey {
    ...
    OpenSSLKey(long j10, boolean z10) {
        this(j10, z10, false);
    }
    ...
    static PrivateKey getPrivateKey(PKCS8EncodedKeySpec pKCS8EncodedKeySpec, int i10) {
        try {
    ...
    static PublicKey getPublicKey(X509EncodedKeySpec x509EncodedKeySpec, int i10) {
        try {
