...
final class ActiveSession implements ConscryptSession {
    ...
    @Override // javax.net.ssl.SSLSession
    public byte[] getId() {
        if (this.f38065id == null) {
            synchronized (this.ssl) {
                this.f38065id = this.ssl.getSessionId();
            }
        }
        byte[] bArr = this.f38065id;
    ...
    void onPeerCertificateAvailable(String str, int i10) {
        synchronized (this.ssl) {
            try {
                this.f38065id = null;
                if (this.localCertificates == null) {
    ...
    void onPeerCertificatesReceived(String str, int i10, X509Certificate[] x509CertificateArr) {
