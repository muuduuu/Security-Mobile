...
final class Java8FileDescriptorSocket extends ConscryptFileDescriptorSocket {
    ...
    Java8FileDescriptorSocket(SSLParametersImpl sSLParametersImpl) {
    ...
    Java8FileDescriptorSocket(String str, int i10, SSLParametersImpl sSLParametersImpl) {
        super(str, i10, sSLParametersImpl);
    }

    Java8FileDescriptorSocket(InetAddress inetAddress, int i10, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i10, sSLParametersImpl);
    }

    Java8FileDescriptorSocket(String str, int i10, InetAddress inetAddress, int i11, SSLParametersImpl sSLParametersImpl) {
        super(str, i10, inetAddress, i11, sSLParametersImpl);
    }

    Java8FileDescriptorSocket(InetAddress inetAddress, int i10, InetAddress inetAddress2, int i11, SSLParametersImpl sSLParametersImpl) {
        super(inetAddress, i10, inetAddress2, i11, sSLParametersImpl);
    }

    Java8FileDescriptorSocket(Socket socket, String str, int i10, boolean z10, SSLParametersImpl sSLParametersImpl) {
