...
final class CoroutineExtsKt$onDefault$2 extends l implements Function2 {
    final /* synthetic */ Function2 $block;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CoroutineExtsKt$onDefault$2(Function2 function2, d dVar) {
        super(2, dVar);
    ...
    public final d<Unit> create(Object obj, d<?> dVar) {
        CoroutineExtsKt$onDefault$2 coroutineExtsKt$onDefault$2 = new CoroutineExtsKt$onDefault$2(this.$block, dVar);
    ...
    public final Object invoke(N n10, d dVar) {
        return ((CoroutineExtsKt$onDefault$2) create(n10, dVar)).invokeSuspend(Unit.f36324a);
    }
